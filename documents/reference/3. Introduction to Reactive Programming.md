...
값을 push 하는 것 외에도 에러 처리나 완료 관점 또한 잘 정의하여 다루어야 합니다. Publisher 는 새로운 값을 Subscript 에게 onNext 메서드를 호출하여 push 할 수 있고 에러(onError 호출) 혹은 완료(onComplete 호출) 메시지를 보낼 수 있습니다. 에러와 완료는 sequence 를 종료시킵니다.
