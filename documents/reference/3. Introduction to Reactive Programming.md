...
Reactor 는 컨베이어 벨트와 단말기 둘 모두 입니다. 원시 자료는 출발지로부터 (원본 **Publisher**) 시작해 최종적으로 푸시가 준비된 소비자(**Subscriber**) 전달할 완제품으로 만들어 집니다.

원시 자료는 다양한 변환과 다른 중간 단계를 거치거나더 중간 처리들을 조립을 수집하는 큰 조립의 일부가 될 수 있습니다.
만약 작은 문제나 막히는 부분이 있다면 피해를 입은 단말은 원시 데이터의 흐름을 제한하기 위해 upstream 으로 신호를 보낼 수 있습니다.
